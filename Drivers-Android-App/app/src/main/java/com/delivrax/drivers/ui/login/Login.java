package com.delivrax.drivers.ui.login;
...
import com.delivrax.drivers.MainActivity;
import com.delivrax.drivers.R;
import com.delivrax.drivers.util.GetData;
import com.delivrax.drivers.util.GlobalVariables;
import com.delivrax.drivers.util.NetworkUtil;
import com.delivrax.drivers.util.SaveData;
...
public class Login extends AppCompatActivity {
    ...
    private void POST_Request(String username, String password){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2:5000/api/drivers/login?Username="+username+"&Password="+password,
    ...
    public void parseData(String response) {
        try {
            ...
            if (jsonObject.getString("Status").equals("Success")) {
                new GetData(Login.this).execute("http://10.0.2.2:5000/api/drivers/assigned/" + jsonObject.getString("DriverID"), "jobsFile");
                ...
                new GetData(Login.this).execute("http://10.0.2.2:5000/api/vehicles/" + jsonObject.getString("VehicleID"), "vehicle");
