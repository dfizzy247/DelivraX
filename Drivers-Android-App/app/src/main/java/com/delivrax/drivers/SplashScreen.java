...
import com.delivrax.drivers.ui.login.Login;
    ...
    public void parseData(String response) {
        try {
            ...
            JSONObject jsonObject = jsonArray.getJSONObject(0);
                ...
                new GetData(SplashScreen.this).execute("http://10.0.2.2:5000/api/vehicles/" + jsonObject.getString("VehicleID"), "vehicle");
                new GetData(SplashScreen.this).execute("http://10.0.2.2:5000/api/drivers/assigned/" + jsonObject.getString("DriverID"), "jobsFile");
