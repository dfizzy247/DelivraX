package com.delivrax.drivers.ui.receipts.receiptsList;
...
import com.delivrax.drivers.ui.receipts.Receipt;
...
public class ReceiptsList extends Fragment {
    ...
    public void loadData(Context c)
    {
            ...
            String url = "http://10.0.2.2:5000/api/receipts/driver/" + ((GlobalVariables) c.getApplicationContext()).getDriverID();
